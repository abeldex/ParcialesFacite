<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reporte_alumno.aspx.cs" Inherits="ParcialesFacite.admin.reportes.reporte_alumno" %>
     ...
     <div class="filter-items">
         ...
         <div class="widget grd">
             ...
             <div class="col-md-6 form-wrp">
                <asp:TextBox ID="txt_alumno" CssClass="brd-rd5" runat="server" CompletionListCssClass="completionList" Width="100%"></asp:TextBox>         
             </div>
			...
			<div class="col-md-3">
                <b>Ciclo: </b> <br />
				<select id="cmb_ciclo" class="form-control">
			 ...
			 <div class="col-md-3">
                <b>Parcial: </b> <br />
				<select id="cmb_parcial" class="form-control">
    ...
    <div class="filter-items" id="i_reportes">
                         ...
                         <asp:Repeater ID="Repeater1" runat="server" DataSourceID="GridDataSource" ClientIDMode="AutoID">
                             ...
                             <asp:SqlDataSource ID="GridDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:TRAYECTORIA_ESCOLARConnectionString %>"
                                 SelectCommand="SELECT id_ep, id_grupo, cohorte, parcial, carrera, semestre, grupo, turno, id_maestro, nombre_maestro, idMateria, NombreMateria, numCuenta, NombreAlumno, calificacion, asistencia, observaciones, estado FROM V_Evaluaciones WHERE (numCuenta LIKE '%' + @alumno + '%') AND cohorte = ''+@ciclo+'' AND parcial = @parcial">
                                 <FilterParameters>
                                     <asp:ControlParameter Name="alumno" ControlID="txt_alumno" PropertyName="Text" />
                                 </FilterParameters>
                                 <SelectParameters>
                                     <asp:QueryStringParameter QueryStringField="alumno" Name="alumno"></asp:QueryStringParameter>
									 <asp:QueryStringParameter QueryStringField="ciclo" Name="ciclo"></asp:QueryStringParameter>
									 <asp:QueryStringParameter QueryStringField="parcial" Name="parcial"></asp:QueryStringParameter>
                                 </SelectParameters>
                             </asp:SqlDataSource>            
    ...
    <script>
        $(document).on('click', '#btn_guardar', function () {
            if ($('#txt_alumno').val() != "") {
                ...
                var ciclo = $('#cmb_ciclo').val();
                var parcial = $('#cmb_parcial').val();
                      //var gpo = '<%=this.Request.QueryString["grupo"]%>';
                $('#lbl_alumno').text(alumno);
                //alert("cuenta:" + nocuenta);
                var QueryString = "http://facitesistemas.gearhostpreview.com/admin/reportes/reporte_alumno.aspx?alumno=" + nocuenta + "&ciclo=" + ciclo + "&parcial=" + parcial;
                //alert(QueryString);
